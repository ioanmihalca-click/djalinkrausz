<div>
    ...
    <!-- Contact Section -->
    <section id="contact" class="py-24 text-white bg-gradient-to-b from-gray-900 to-black">
        <div class="container px-8 mx-auto max-w-7xl">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            <div class="flex-shrink-0 p-4 rounded-lg bg-indigo-600/20">
                                <svg class="w-6 h-6 text-indigo-400" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="ml-4">
                                ...
                                <p class="mt-1 text-gray-300">+40 700 000 000</p>
                            </div>
                        </div>
                    ...
                    <div class="relative">
                        ...
                        <div
                            ...
                            <form>
                                <div class="mb-6">
                                    <label for="name"
                                        class="block mb-2 text-sm font-medium text-gray-300">Nume</label>
